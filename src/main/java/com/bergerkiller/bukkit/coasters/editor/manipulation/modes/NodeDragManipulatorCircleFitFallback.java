...
public class NodeDragManipulatorCircleFitFallback {
    ...
    public void onStarted(PlayerEditState state, Collection<PlayerEditNode> editedNodes, NodeDragEvent event) {
        ...
        NodeDragManipulatorCircleFit.PlaneBasis basis = NodeDragManipulatorCircleFit.PlaneBasis.estimateFromPoints(points, upOrientation);
        ...
        NodeDragManipulatorCircleFit.Circle2D circle2D = fitCircleTaubinLike(xs, ys);
    ...
    @Override
    public void onFinished(PlayerEditState state, com.bergerkiller.bukkit.coasters.editor.history.HistoryChangeCollection history, Collection<PlayerEditNode> editedNodes, NodeDragEvent event) throws com.bergerkiller.bukkit.coasters.editor.history.ChangeCancelledException {
