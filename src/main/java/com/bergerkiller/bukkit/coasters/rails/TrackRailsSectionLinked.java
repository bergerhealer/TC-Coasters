...
public class TrackRailsSectionLinked extends TrackRailsSection {
    ...
    public TrackRailsSectionLinked(List<TrackRailsSection> sections) {
        super(findBestSection(sections), combineRailPaths(sections), combineExtendedRailPaths(sections));
    ...
    private static RailPath combineExtendedRailPaths(List<TrackRailsSection> sections) {
        RailPath.Builder builder = new RailPath.Builder();
        ...
        TrackRailsSection first = sections_it.next();
        TrackRailsSection second = sections_it.next();
        RailPath.Point[] first_points = first.path_extended.getPoints();
        RailPath.Point[] second_points = second.path_extended.getPoints();
        ...
        // Add points of all remaining sections
        while (sections_it.hasNext()) {
            RailPath.Point[] next_points = sections_it.next().path_extended.getPoints();
